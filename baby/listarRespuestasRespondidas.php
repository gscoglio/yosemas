...
<html>
    ...
    <?php include_once './cabecera.php'; ?>
        ...
        <div class="demo" style="width:100%"> 
        	...
        	<div style="display:inline; float:right"> <a href="listarPreguntasRespondidas.php">Volver</a> </div>
			
             <h2 align="center"> Lista de Respuestas Respondidas </h2>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
	...
	<tr class="gradeC">
            ...
            <td class="center"><?php 
									if( $correcta == 1) echo "<font color=red><b>Ganadora</b></font>";
									else echo "";		
								?></td>
			<td class="center"><?php echo $cantVotos ?></td>
            <td class="center"><?php 
								if( $correcta == 1) { ?> <a href="volverRespuesta.php?idResp=<?php echo $id_resp; ?>">[Deshacer Respuesta]</a>
							<?php }
								else echo "";	
            					?> </td>

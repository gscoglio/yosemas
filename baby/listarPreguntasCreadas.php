...
<html>
    ...
    <?php include_once './cabecera.php'; ?>
   	...
   	<div style="width:100%" > 
        <h2 align="center"> Lista De Preguntas en el Estado Creadas </h2>
		...
		?>
			...
			<tr class="odd gradeX" >
					...
					<td class="center"> <a href="accionesRespuestaCreada.php?idPreg=<?php  echo $id_preg; ?> " > [Ver, Modificar o Agregar]</a> 
					 </td>

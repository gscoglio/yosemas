...
<div style="display:inline; float:right"> <a href="listarPreguntasPublicadas.php">Volver</a> </div>

<FORM ACTION="accionesRespuestaPublicada.php?idPreg=<?php  echo $idPregunta; ?>" METHOD="post">
...
?>      
    ...
    <tr>
      ...
      <td ><input type="text" id="from2" name="from" size="15" readonly="readonly" value="<?php echo(trim($from)); ?>"></td>
     ...
     <tr>
      ...
      <td >
      <input type="text" id="horaStart" name="horaStart" size="15" readonly="readonly" value="<?php echo(trim($start)); ?>">
      </td>
...
<!--  <div class='timepicker_button_trigger'
    ...
    <tr>
    <td colspan="2" align="center"> <input name="cargarPregunta" type="submit" class="boton" value="Modificar Pregunta" /> </td>
    </tr>
  </table>
</FORM>
...
<?php else: 
	...
	fecha_fin='".$fechaFin."' WHERE id=$idPregunta") or die("Problemas en el update:".mysql_error());
	
//	echo " Valor del contador: $contador - Muestra cuantas respuestas hay <br>";
//	echo " Valor de i: $i - Muestra cuantas respuestas fueron cargadas desde la BD <br>";
//	echo " Valores de los ID: $id1[1] $id2[1] $id3[1] $id4[1] $id5[1] $id6[1] $id7[1] $id8[1] <br>";
...
//		('".$idPregunta."', '".${'reply'.$k}[1]."', '".$calificacion."', '".$votos."')");	
...
<DIV class="demo"  align="center">
    ...
    <table border="0" width="500">  
      ...
      <tr align="center">
           <td><h4>Para ver mas preguntas publicadas presiona en el boton Ver Preguntas Publicadas. </h4></td>
      </tr>
      
      <tr align="center">
        <td> <a href="listarPreguntasPublicadas.php">Ver Preguntas Publicadas</a> </td>
      </tr>

...
if(isset($_POST['cargarPregunta'])){
		...
		if(isset($_POST['respuesta5']) && $_POST['respuesta5']!=""){
		$reply5=$_POST['respuesta5'];
		}
		if(isset($_POST['respuesta6']) && $_POST['respuesta6']!=""){
		$reply6=$_POST['respuesta6'];
		}
		if(isset($_POST['respuesta7']) && $_POST['respuesta7']!=""){
		$reply7=$_POST['respuesta7'];
		}
		if(isset($_POST['respuesta8']) && $_POST['respuesta8']!=""){
...
<DIV class="demo" align="center">
 ...
 <table border="0" width="500">
      ...
      <tr align="center">
        <td> <a href="index.php">Cargar otra Pregunta</a> </td>
      </tr>
